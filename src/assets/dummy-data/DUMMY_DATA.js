const DUMMY_DATA = {
  ...
  dummyTeamInfoWBM: [
    {
      ...
      teamName: "LucyRiver",
      owner: "WJJ",
      members: ["WJJ", "WBM", "ChangChang", "JamesYang", "President", "LZY"],
  ...
  dummyTeamsInfoWBM2: {
    userOwnTeams: [{ idTeam: "1", teamName: "Lucy" }],
    userInTeams: [{ idTeam: "2", teamName: "Lucy2" }],
  },

  dummyTeamMemberInfoWBM3: [{userName: 'WWW',idUser: '24142425'},]
};
